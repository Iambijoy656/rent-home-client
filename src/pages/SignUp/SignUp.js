            ...
            <div className='w-96 p-8 shadow-2xl'>
                ...
                <form onSubmit={handleSubmit(handleSignUp)}>
                    ...
                    <div className="form-control w-full max-w-xs">
                        ...
                        >
                            <option disabled selected>Owner Or Renter?</option>
                            <option>owner</option>
                ...
                <div className="flex items-center mt-6 -mx-2">
                    <button onClick={handleGoogleSignIn} type="button" className="flex items-center justify-center w-full px-6 py-2 mx-2 text-sm font-medium text-white transition-colors duration-300 transform rounded-md bg-[#f97316] hover:bg-orange-600 focus:outline-none">
